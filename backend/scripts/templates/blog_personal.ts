// 📂 PFAD: backend/scripts/templates/blog_personal.ts
// Paket: blog_personal — Reiseblog "Fernweh" von Anna Richter
// Run: npx ts-node -r tsconfig-paths/register scripts/templates/blog_personal.ts [--force]
