// 📂 PFAD: backend/scripts/templates/restaurant_premium.ts
// Paket: restaurant_premium — "Goldener Karpfen", Fine Dining Hamburg
// Run: npx ts-node -r tsconfig-paths/register scripts/templates/restaurant_premium.ts [--force]
