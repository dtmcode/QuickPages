// 📂 PFAD: backend/scripts/templates/local_pro.ts
// Paket: local_pro — Apotheke am Markt, Frankfurt
// Run: npx ts-node -r tsconfig-paths/register scripts/templates/local_pro.ts [--force]
