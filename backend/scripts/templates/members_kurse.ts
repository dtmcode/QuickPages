// 📂 PFAD: backend/scripts/templates/members_kurse.ts
// Paket: members_kurse — "Digital Marketing Masterclass" von Jonas Krause
// Run: npx ts-node -r tsconfig-paths/register scripts/templates/members_kurse.ts [--force]
