...
async function main() {
    ...
    const [portfolio] = await db.insert(website_builder_schema_1.wbGlobalTemplatePages).values({ templateId: t.id, name: 'Portfolio', slug: '/portfolio', isHomepage: false, order: 1 }).returning();
    await db.insert(website_builder_schema_1.wbGlobalTemplateSections).values([
    ...
    const [preise] = await db.insert(website_builder_schema_1.wbGlobalTemplatePages).values({ templateId: t.id, name: 'Preise', slug: '/preise', isHomepage: false, order: 2 }).returning();
    await db.insert(website_builder_schema_1.wbGlobalTemplateSections).values([
...
//# sourceMappingURL=website_pro.js.map