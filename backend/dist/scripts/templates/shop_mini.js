...
<blockquote><em>"Ich möchte, dass jeder der ein AURYN-Stück trägt, spürt wie viel Herzblut darin steckt."</em> — Nele Hartmann</blockquote>`,
    ...
    const [shop] = await db.insert(website_builder_schema_1.wbGlobalTemplatePages).values({
        templateId: template.id,
        name: 'Shop',
        slug: '/shop',
        isHomepage: false,
    ...
    const [about] = await db.insert(website_builder_schema_1.wbGlobalTemplatePages).values({
        templateId: template.id,
        name: 'Über uns',
        slug: '/ueber-uns',
        isHomepage: false,
...
//# sourceMappingURL=shop_mini.js.map