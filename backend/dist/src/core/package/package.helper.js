...
exports.PACKAGES = {
    ...
    restaurant_starter: {
        ...
        description: 'Speisekarte, Tischbestellungen und Reservierungen für Einsteiger.',
        priceMonthly: 2900,
        features: {
            websiteBuilder: true,
            maxPages: 10,
    ...
    restaurant_premium: {
        ...
        description: 'Mehrere Standorte, AI-Content, Mehrsprachigkeit und volle Analytics.',
        priceMonthly: 9900,
        features: {
            websiteBuilder: true,
            maxPages: 80,
    ...
    local_starter: {
        ...
        description: 'Click & Collect für Apotheken, Bäckereien und lokale Geschäfte.',
        priceMonthly: 2900,
        features: {
            websiteBuilder: true,
            maxPages: 10,
    ...
    funnels_premium: {
        ...
        description: 'Unbegrenzte Funnels, AI-Texte und volle Marketing-Automation.',
        priceMonthly: 9900,
        features: {
            websiteBuilder: true,
            maxPages: 100,
...
exports.ADDONS = {
    ...
    restaurant_module: {
        ...
        description: 'Digitale Speisekarte, Tischbestellungen, Lieferung und Abholung.',
        priceMonthly: 1900,
        icon: '🍽️',
...
exports.PACKAGE_CATEGORIES = [
    ...
    },
    {
        ...
        description: 'Speisekarte, Bestellungen, Reservierungen — alles für dein Restaurant.',
        color: 'from-orange-500 to-red-500',
    ...
    },
    {
        ...
        tiers: ['local_starter', 'local_pro', 'local_premium'],
    },
    {
        id: 'funnels',
        label: 'Funnels',
