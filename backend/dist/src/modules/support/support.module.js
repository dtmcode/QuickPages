...
const support_public_controller_1 = require("./support-public.controller");
let SupportModule = class SupportModule {
};
exports.SupportModule = SupportModule;
exports.SupportModule = SupportModule = __decorate([
    (0, common_1.Module)({
        controllers: [support_public_controller_1.SupportPublicController],
        providers: [support_service_1.SupportService, support_resolver_1.SupportResolver],
