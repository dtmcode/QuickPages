...
const form_builder_resolver_1 = require("./form-builder.resolver");
const form_builder_public_controller_1 = require("./form-builder-public.controller");
...
exports.FormBuilderModule = FormBuilderModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [form_builder_public_controller_1.FormBuilderPublicController],
        providers: [form_builder_service_1.FormBuilderService, form_builder_resolver_1.FormBuilderResolver],
