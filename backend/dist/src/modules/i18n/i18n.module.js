...
const i18n_resolver_1 = require("./i18n.resolver");
const i18n_public_controller_1 = require("./i18n-public.controller");
let I18nModule = class I18nModule {
};
exports.I18nModule = I18nModule;
exports.I18nModule = I18nModule = __decorate([
    (0, common_1.Module)({
        controllers: [i18n_public_controller_1.I18nPublicController],
        providers: [i18n_service_1.I18nService, i18n_resolver_1.I18nResolver],
