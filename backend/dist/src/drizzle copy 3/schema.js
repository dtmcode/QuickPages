...
exports.templatesRelations = exports.pageSections = exports.websiteTemplatePageSections = exports.websiteTemplatePages = exports.websiteTemplates = exports.templateSections = exports.sections = exports.templates = exports.seoMeta = exports.navigationItems = exports.navigations = exports.mediaFiles = exports.campaignQueue = exports.campaignEvents = exports.newsletterCampaigns = exports.newsletterSubscribers = exports.tenantEmailTemplates = exports.tenantEmailSettings = exports.emailEvents = exports.emailLogs = exports.passwordResetTokens = exports.orderItems = exports.orders = exports.products = exports.categories = exports.pages = exports.posts = exports.auditLogs = exports.refreshTokens = exports.users = exports.usageTracking = exports.tenantAddons = exports.subscriptions = exports.tenants = exports.campaignEventTypeEnum = exports.campaignStatusEnum = exports.subscriberStatusEnum = exports.emailProviderEnum = exports.mediaTypeEnum = exports.sectionTypeEnum = exports.templateCategoryEnum = exports.websiteTemplateCategoryEnum = exports.orderStatusEnum = exports.pageTemplateEnum = exports.postStatusEnum = exports.subscriptionStatusEnum = exports.addonTypeEnum = exports.shopTemplateEnum = exports.packageEnum = exports.userRoleEnum = void 0;
exports.pagesRelations = exports.pageSectionsRelations = exports.websiteTemplatePageSectionsRelations = exports.websiteTemplatePagesRelations = exports.websiteTemplatesRelations = exports.navigationItemsRelations = exports.navigationsRelations = exports.templateSectionsRelations = exports.sectionsRelations = void 0;
...
exports.websiteTemplateCategoryEnum = (0, pg_core_1.pgEnum)('website_template_category', [
    'business',
    'shop',
    'blog',
    'landing',
...
exports.templateCategoryEnum = (0, pg_core_1.pgEnum)('template_category', [
    'business',
    'shop',
    'blog',
    'landing',
...
exports.sectionTypeEnum = (0, pg_core_1.pgEnum)('section_type', [
    'hero',
    'features',
    'contact',
    'newsletter',
...
exports.pages = (0, pg_core_1.pgTable)('pages', {
    ...
    isPublished: (0, pg_core_1.boolean)('is_published').default(false).notNull(),
    publishedAt: (0, pg_core_1.timestamp)('published_at'),
    appliedWebsiteTemplateId: (0, pg_core_1.uuid)('applied_website_template_id'),
    sourceTemplatePageId: (0, pg_core_1.uuid)('source_template_page_id'),
    createdAt: (0, pg_core_1.timestamp)('created_at').defaultNow(),
    updatedAt: (0, pg_core_1.timestamp)('updated_at').defaultNow(),
}, (table) => ({
    ...
    appliedTemplateIdx: (0, pg_core_1.index)('pages_applied_template_idx').on(table.appliedWebsiteTemplateId),
    sourceTemplatePageIdx: (0, pg_core_1.index)('pages_source_template_page_idx').on(table.sourceTemplatePageId),
}));
...
exports.templates = (0, pg_core_1.pgTable)('templates', {
    ...
    name: (0, pg_core_1.varchar)('name', { length: 255 }).notNull(),
    category: (0, exports.templateCategoryEnum)('category').notNull(),
    description: (0, pg_core_1.text)('description'),
    thumbnail: (0, pg_core_1.text)('thumbnail'),
    isPreset: (0, pg_core_1.boolean)('is_preset').default(false).notNull(),
    ...
    tenantIdx: (0, pg_core_1.index)('templates_tenant_idx').on(table.tenantId),
    categoryIdx: (0, pg_core_1.index)('templates_category_idx').on(table.category),
    presetIdx: (0, pg_core_1.index)('templates_preset_idx').on(table.isPreset),
}));
exports.sections = (0, pg_core_1.pgTable)('sections', {
    ...
    tenantIdx: (0, pg_core_1.index)('sections_tenant_idx').on(table.tenantId),
    typeIdx: (0, pg_core_1.index)('sections_type_idx').on(table.type),
    presetIdx: (0, pg_core_1.index)('sections_preset_idx').on(table.isPreset),
}));
exports.templateSections = (0, pg_core_1.pgTable)('template_sections', {
    id: (0, pg_core_1.uuid)('id').primaryKey().defaultRandom(),
    templateId: (0, pg_core_1.uuid)('template_id')
        .notNull()
        .references(() => exports.templates.id, { onDelete: 'cascade' }),
    sectionId: (0, pg_core_1.uuid)('section_id')
        .notNull()
        .references(() => exports.sections.id, { onDelete: 'cascade' }),
    orderIndex: (0, pg_core_1.integer)('order_index').notNull(),
    overrideConfig: (0, pg_core_1.jsonb)('override_config')
        .$type()
        .default({}),
    createdAt: (0, pg_core_1.timestamp)('created_at').defaultNow().notNull(),
}, (table) => ({
    templateIdx: (0, pg_core_1.index)('template_sections_template_idx').on(table.templateId),
    sectionIdx: (0, pg_core_1.index)('template_sections_section_idx').on(table.sectionId),
    orderIdx: (0, pg_core_1.index)('template_sections_order_idx').on(table.orderIndex),
}));
exports.websiteTemplates = (0, pg_core_1.pgTable)('website_templates', {
    id: (0, pg_core_1.uuid)('id').primaryKey().defaultRandom(),
    tenantId: (0, pg_core_1.uuid)('tenant_id').references(() => exports.tenants.id, {
        onDelete: 'cascade',
    }),
    name: (0, pg_core_1.varchar)('name', { length: 255 }).notNull(),
    category: (0, exports.websiteTemplateCategoryEnum)('category').notNull(),
    description: (0, pg_core_1.text)('description'),
    thumbnail: (0, pg_core_1.text)('thumbnail'),
    isPreset: (0, pg_core_1.boolean)('is_preset').default(false).notNull(),
    isPublic: (0, pg_core_1.boolean)('is_public').default(false).notNull(),
    ...
    tenantIdx: (0, pg_core_1.index)('website_templates_tenant_idx').on(table.tenantId),
    categoryIdx: (0, pg_core_1.index)('website_templates_category_idx').on(table.category),
    presetIdx: (0, pg_core_1.index)('website_templates_preset_idx').on(table.isPreset),
}));
exports.websiteTemplatePages = (0, pg_core_1.pgTable)('website_template_pages', {
    id: (0, pg_core_1.uuid)('id').primaryKey().defaultRandom(),
    templateId: (0, pg_core_1.uuid)('template_id')
        .notNull()
        .references(() => exports.websiteTemplates.id, { onDelete: 'cascade' }),
    name: (0, pg_core_1.varchar)('name', { length: 255 }).notNull(),
    ...
    templateIdx: (0, pg_core_1.index)('website_template_pages_template_idx').on(table.templateId),
    templateSlugIdx: (0, pg_core_1.uniqueIndex)('website_template_pages_template_slug_idx').on(table.templateId, table.slug),
    orderIdx: (0, pg_core_1.index)('website_template_pages_order_idx').on(table.orderIndex),
}));
exports.websiteTemplatePageSections = (0, pg_core_1.pgTable)('website_template_page_sections', {
    id: (0, pg_core_1.uuid)('id').primaryKey().defaultRandom(),
    templatePageId: (0, pg_core_1.uuid)('template_page_id')
        .notNull()
        .references(() => exports.websiteTemplatePages.id, { onDelete: 'cascade' }),
    sectionId: (0, pg_core_1.uuid)('section_id')
        .notNull()
        .references(() => exports.sections.id, { onDelete: 'cascade' }),
    orderIndex: (0, pg_core_1.integer)('order_index').default(0).notNull(),
    ...
    templatePageIdx: (0, pg_core_1.index)('website_template_page_sections_page_idx').on(table.templatePageId),
    sectionIdx: (0, pg_core_1.index)('website_template_page_sections_section_idx').on(table.sectionId),
    orderIdx: (0, pg_core_1.index)('website_template_page_sections_order_idx').on(table.orderIndex),
}));
exports.pageSections = (0, pg_core_1.pgTable)('page_sections', {
    id: (0, pg_core_1.uuid)('id').primaryKey().defaultRandom(),
    ...
    overrideConfig: (0, pg_core_1.jsonb)('override_config')
        .$type()
        .default({}),
    sourceTemplatePageId: (0, pg_core_1.uuid)('source_template_page_id').references(() => exports.websiteTemplatePages.id, { onDelete: 'set null' }),
    createdAt: (0, pg_core_1.timestamp)('created_at').defaultNow().notNull(),
    updatedAt: (0, pg_core_1.timestamp)('updated_at').defaultNow().notNull(),
}, (table) => ({
    pageIdx: (0, pg_core_1.index)('page_sections_page_idx').on(table.pageId),
    sectionIdx: (0, pg_core_1.index)('page_sections_section_idx').on(table.sectionId),
    orderIdx: (0, pg_core_1.index)('page_sections_order_idx').on(table.orderIndex),
    sourcePageIdx: (0, pg_core_1.index)('page_sections_source_page_idx').on(table.sourceTemplatePageId),
}));
exports.templatesRelations = (0, drizzle_orm_1.relations)(exports.templates, ({ one, many }) => ({
    tenant: one(exports.tenants, {
        fields: [exports.templates.tenantId],
        references: [exports.tenants.id],
    }),
    createdByUser: one(exports.users, {
        fields: [exports.templates.createdBy],
        references: [exports.users.id],
    }),
    templateSections: many(exports.templateSections),
}));
exports.sectionsRelations = (0, drizzle_orm_1.relations)(exports.sections, ({ one, many }) => ({
    tenant: one(exports.tenants, {
        fields: [exports.sections.tenantId],
        references: [exports.tenants.id],
    }),
    templateSections: many(exports.templateSections),
    websiteTemplatePageSections: many(exports.websiteTemplatePageSections),
    pageSections: many(exports.pageSections),
}));
exports.templateSectionsRelations = (0, drizzle_orm_1.relations)(exports.templateSections, ({ one }) => ({
    template: one(exports.templates, {
        fields: [exports.templateSections.templateId],
        references: [exports.templates.id],
    }),
    section: one(exports.sections, {
        fields: [exports.templateSections.sectionId],
        references: [exports.sections.id],
    }),
}));
exports.navigationsRelations = (0, drizzle_orm_1.relations)(exports.navigations, ({ many, one }) => ({
    tenant: one(exports.tenants, {
...
exports.websiteTemplatesRelations = (0, drizzle_orm_1.relations)(exports.websiteTemplates, ({ one, many }) => ({
    tenant: one(exports.tenants, {
        fields: [exports.websiteTemplates.tenantId],
        references: [exports.tenants.id],
    }),
    createdByUser: one(exports.users, {
        fields: [exports.websiteTemplates.createdBy],
        references: [exports.users.id],
    }),
    pages: many(exports.websiteTemplatePages),
}));
exports.websiteTemplatePagesRelations = (0, drizzle_orm_1.relations)(exports.websiteTemplatePages, ({ one, many }) => ({
    template: one(exports.websiteTemplates, {
        fields: [exports.websiteTemplatePages.templateId],
        references: [exports.websiteTemplates.id],
    }),
    sections: many(exports.websiteTemplatePageSections),
}));
exports.websiteTemplatePageSectionsRelations = (0, drizzle_orm_1.relations)(exports.websiteTemplatePageSections, ({ one }) => ({
    templatePage: one(exports.websiteTemplatePages, {
        fields: [exports.websiteTemplatePageSections.templatePageId],
        references: [exports.websiteTemplatePages.id],
    }),
    section: one(exports.sections, {
        fields: [exports.websiteTemplatePageSections.sectionId],
        references: [exports.sections.id],
    }),
}));
exports.pageSectionsRelations = (0, drizzle_orm_1.relations)(exports.pageSections, ({ one }) => ({
    page: one(exports.pages, {
        fields: [exports.pageSections.pageId],
        references: [exports.pages.id],
    }),
    section: one(exports.sections, {
        fields: [exports.pageSections.sectionId],
        references: [exports.sections.id],
    }),
    sourceTemplatePage: one(exports.websiteTemplatePages, {
        fields: [exports.pageSections.sourceTemplatePageId],
        references: [exports.websiteTemplatePages.id],
    }),
}));
exports.pagesRelations = (0, drizzle_orm_1.relations)(exports.pages, ({ one, many }) => ({
    ...
    appliedWebsiteTemplate: one(exports.websiteTemplates, {
        fields: [exports.pages.appliedWebsiteTemplateId],
        references: [exports.websiteTemplates.id],
    }),
    sourceTemplatePage: one(exports.websiteTemplatePages, {
        fields: [exports.pages.sourceTemplatePageId],
        references: [exports.websiteTemplatePages.id],
    }),
    pageSections: many(exports.pageSections),
}));
