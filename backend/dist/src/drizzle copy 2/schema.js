...
exports.templateSectionsRelations = exports.sectionsRelations = exports.templatesRelations = exports.templateSections = exports.sections = exports.templates = exports.sectionTypeEnum = exports.templateCategoryEnum = exports.navigationItemsRelations = exports.navigationsRelations = exports.navigationItems = exports.navigations = exports.seoMeta = exports.navigationMenus = exports.mediaFiles = exports.mediaTypeEnum = exports.campaignQueue = exports.campaignEvents = exports.newsletterCampaigns = exports.newsletterSubscribers = exports.campaignEventTypeEnum = exports.campaignStatusEnum = exports.subscriberStatusEnum = exports.tenantEmailTemplates = exports.tenantEmailSettings = exports.emailProviderEnum = exports.emailEvents = exports.emailLogs = exports.passwordResetTokens = exports.orderItems = exports.orders = exports.products = exports.categories = exports.pages = exports.posts = exports.auditLogs = exports.refreshTokens = exports.users = exports.usageTracking = exports.tenantAddons = exports.subscriptions = exports.tenants = exports.orderStatusEnum = exports.pageTemplateEnum = exports.postStatusEnum = exports.subscriptionStatusEnum = exports.addonTypeEnum = exports.shopTemplateEnum = exports.packageEnum = exports.userRoleEnum = void 0;
...
exports.navigationMenus = (0, pg_core_1.pgTable)('navigation_menus', {
    id: (0, pg_core_1.uuid)('id').primaryKey().defaultRandom(),
    tenantId: (0, pg_core_1.uuid)('tenant_id')
        .notNull()
        .references(() => exports.tenants.id, { onDelete: 'cascade' }),
    ...
    items: (0, pg_core_1.jsonb)('items').notNull().default([]),
    isActive: (0, pg_core_1.boolean)('is_active').default(true).notNull(),
    createdAt: (0, pg_core_1.timestamp)('created_at').defaultNow().notNull(),
    updatedAt: (0, pg_core_1.timestamp)('updated_at').defaultNow().notNull(),
}, (table) => ({
    tenantLocationIdx: (0, pg_core_1.uniqueIndex)('navigation_menus_tenant_location_idx').on(table.tenantId, table.location),
}));
